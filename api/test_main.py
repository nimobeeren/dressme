...
def test_get_users_success(session: Session, client: TestClient):
...
def test_get_wearables_success(session: Session, client: TestClient):
...
def test_get_wearable_image_success(session: Session, client: TestClient):
...
def test_get_wearable_image_not_found(session: Session, client: TestClient):
