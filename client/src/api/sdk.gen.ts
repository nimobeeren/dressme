...
import type { GetUsersData, GetUsersResponse, GetAvatarImageData, GetAvatarImageResponse, GetAvatarImageError, GetWearablesData, GetWearablesResponse, CreateWearablesData, CreateWearablesResponse, CreateWearablesError, GetWearableImageData, GetWearableImageResponse, GetWearableImageError, GetOutfitData, GetOutfitResponse, GetOutfitError, DeleteOutfitData, DeleteOutfitError, GetOutfitsData, GetOutfitsResponse, CreateOutfitData, CreateOutfitError } from './types.gen';
 ...
 * Get Outfit
 */
export const getOutfit = <ThrowOnError extends boolean = true>(options: Options<GetOutfitData, ThrowOnError>) => {
