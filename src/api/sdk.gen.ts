...
import type { HealthData, GetMeData, GetMeResponse, UpdateAvatarImageData, UpdateAvatarImageError, GetWearablesData, GetWearablesResponse, CreateWearablesData, CreateWearablesResponse, CreateWearablesError, ClassifyWearableData, ClassifyWearableResponse, ClassifyWearableError, GetOutfitImageData, GetOutfitImageError, DeleteOutfitData, DeleteOutfitError, GetOutfitsData, GetOutfitsResponse, CreateOutfitData, CreateOutfitError } from './types.gen';
 ...
 * Classify Wearable
 */
export const classifyWearable = <ThrowOnError extends boolean = true>(options: Options<ClassifyWearableData, ThrowOnError>) => {
    return (options?.client ?? client).post<ClassifyWearableResponse, ClassifyWearableError, ThrowOnError>({
        ...options,
        ...formDataBodySerializer,
        headers: {
            'Content-Type': null,
...
export const getOutfitImage = <ThrowOnError extends boolean = true>(options: Options<GetOutfitImageData, ThrowOnError>) => {
    return (options?.client ?? client).get<unknown, GetOutfitImageError, ThrowOnError>({
        ...options,
        security: [
            {
                scheme: 'bearer',
