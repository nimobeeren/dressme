...
export const getWearableImage = <ThrowOnError extends boolean = true>(options: Options<GetWearableImageData, ThrowOnError>) => {
    return (options?.client ?? client).get<unknown, GetWearableImageError, ThrowOnError>({
        ...options,
        security: [
            {
                scheme: 'bearer',
