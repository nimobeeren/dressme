/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1503de2ae543a5bfa1ebc5da2cdf0715)
// Runtime types generated with workerd@1.20250730.0 2025-08-01
declare namespace Cloudflare {
  interface Env {
    VITE_API_BASE_URL: string;
    VITE_AUTH0_API_AUDIENCE: string;
    VITE_AUTH0_CLIENT_ID: string;
    VITE_AUTH0_DOMAIN: string;
    DRESSME_API: DurableObjectNamespace<import("./worker/index").DressmeAPI>;
  }
}
